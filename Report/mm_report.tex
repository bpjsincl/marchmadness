...
However, there is no agreed upon or industry standardized method for predicting a bracket, or even the outcome of a basketball game. 
...
The data used for creating predictions was gathered from multiple sources. Firstly, the Kaggle competition data served as a base of information and other statistics integrated into this dataset. Next, kenpom.com's <data>. This dataset includes 30 statistics about each team
