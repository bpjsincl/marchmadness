...
Additionally, to determine techniques success, the researchers used Log Loss and evaluated predictions against Kaggle results.
Through the analysis the researchers found that the Random Forest is the superior method, with bracket prediction accuracy of <> and log loss of <>.
\end{abstract}
...
Additionally, increasing the number of hidden layers beyond three was reasearched, but not tested.
